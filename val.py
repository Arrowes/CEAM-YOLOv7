...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp 5 gam3 Mish0/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--name', default='exp 5 gam3 Mish0', help='save to project/name') ######################
